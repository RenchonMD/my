...
public class FloatingModMenuService extends Service {
    ...
    int TEXT_COLOR_2 = Color.parseColor("#000000");
	int TEXT_COLOR_4 = Color.parseColor("#000000");
	int TEXT_COLOR_5 = Color.parseColor("#000000");
    int BTN_COLOR = Color.parseColor("#E5E5E5");
    int MENU_BG_COLOR = Color.parseColor("#FFFFFF"); //#AARRGGBB
    ...
    int ToggleON = Color.parseColor("#009688");
    int ToggleOFF = Color.LTGRAY;
    int BtnON = Color.parseColor("#009688");
    int BtnOFF = Color.LTGRAY;
    int CategoryBG = Color.parseColor("#D3D3D3");
    int SeekBarColor =  Color.parseColor("#1ABC9C");
    int SeekBarProgressColor = Color.parseColor("#1ABC9C");
    int CheckBoxColor = Color.parseColor("#009688");
    int RadioColor = Color.parseColor("#FFFFFF");
    String NumberTxtColor = "#1ABC9C";
    //********************************************************************//
    ...
    private void initFloating() {
        ...
        mExpanded.setPadding(7, 7, 7, 7); //So borders would be visible
        ...
        gdMenuBody.setStroke(5, Color.parseColor("#009688")); //Set border
        ...
        hideBtn.setTextColor(TEXT_COLOR_4);
		GradientDrawable gdBtn = new GradientDrawable();
        gdBtn.setCornerRadius(12f);
        hideBtn.setBackground(gdBtn);
        ...
        closeBtn.setTextColor(TEXT_COLOR_5);	
		GradientDrawable gdBtn2 = new GradientDrawable();
        gdBtn2.setCornerRadius(12f);
        closeBtn.setBackground(gdBtn2);
    ...
    private View Spinner(final int featNum, final String featName, final String list) {
        ...
        layoutParams2.setMargins(7, 2, 7, 5);//7, 2, 7, 5);
        linearLayout2.setOrientation(LinearLayout.VERTICAL);

        GradientDrawable SP_THUMB = new GradientDrawable();
        //SP_THUMB.setCornerRadius(MENU_CORNER);
        SP_THUMB.setCornerRadii(new float[]{30, 30, 0, 0, 30, 30, 0, 0});
        SP_THUMB.setColor(Color.parseColor("#FFFFFF")); //0700FF
        SP_THUMB.setStroke(4, Color.parseColor("#009688"));
        linearLayout2.setBackground(SP_THUMB); 
        //linearLayout2.setTypeface(null, Typeface.BOLD);
    ...
    private View TextField(final int featNum, final String featName, final boolean numOnly, final int maxValue) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
				...
				TextViewNote.setText("値,テキストを入力してください [Max 2147483640]");
				if (maxValue != 0)
